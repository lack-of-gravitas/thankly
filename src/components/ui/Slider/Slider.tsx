...
const Hero: FC<HeroProps> = ({ data }) => {
  ...
  return (
    ...
    //                 : '#fff',
    //             }}
    //             className="inline-block px-8 py-3 mt-8 font-medium prose-xl text-white border rounded-xs border-slate-100 hover:border-slate-300 hover:bg-gray-100 hover:text-slate-500"
    //             type="button"
    //             // item={item}
