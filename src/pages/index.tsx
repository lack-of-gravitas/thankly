      ...
      <main>
        ...
        >
          <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
            ...
            <a
              href="#"
              className="hidden text-sm font-semibold text-slate-500 hover:text-indigo-500 sm:block"
            >
          ...
          <div className="px-4 mt-6 sm:hidden">
            <a
              href="#"
              className="block text-sm font-semibold text-slate-500 hover:text-indigo-500"
            >
              Browse all categories<span aria-hidden="true"> &rarr;</span>
            </a>
          </div>
            ...
            <div className="grid grid-cols-1 mt-6 gap-y-10 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:gap-x-8">
              {favorites.map((favorite) => (
                <div key={favorite.id} className="relative group">
                  <div className="w-full overflow-hidden rounded-md h-96 group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-3 sm:h-auto">
                    <img
